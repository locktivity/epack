...
// WrapperFlags holds parsed wrapper-level flags for tool execution.
// These flags control the wrapper's behavior, not the tool's.
...
func WrapperFlagsFromEnv() WrapperFlags {
	return WrapperFlags{
		...
		InsecureAllowUnpinned: os.Getenv("EPACK_INSECURE_ALLOW_UNPINNED") == "true" || os.Getenv("EPACK_INSECURE_ALLOW_UNPINNED") == "1",
	}
}
